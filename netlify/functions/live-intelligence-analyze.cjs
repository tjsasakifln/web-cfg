...
<button class="button button-secondary" type="button" data-intel-cta="request" data-intent-kind="REQUEST_HUMAN_REVIEW" data-cta-id="intel_request_human_review" data-cta-position="company_next_action">Pedir revisão do responsável técnico</button>
</div>
