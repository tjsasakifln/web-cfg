...
function buildLeadRecord({ lead_id, lead, received_at, ip_hash, fingerprint, status, headers }) {
  ...
  return {
    ...
    source: "CONFENGE_WEB",
    adaptive_intake: Boolean(lead.adaptive_intake),
    need_code: lead.need_code || null,
    nucleus_id: lead.nucleus_id || null,
    offer_candidate_id: lead.offer_candidate_id || null,
    source_asset_id: lead.source_asset_id || null,
    landing_family: lead.landing_family || null,
    city_class: lead.city_class || null,
    site_class: lead.site_class || null,
    location_material: lead.adaptive_intake ? Boolean(lead.location_material) : null,
    city: lead.city || null,
    uf: lead.uf || null,
    decision_role: lead.decision_role || null,
    pessoa_tipo: lead.pessoa_tipo || null,
    ...
    taxonomy_version: lead.taxonomy_version || null,
    offer_catalog_version: lead.offer_catalog_version || null,
    admission_policy_version: lead.admission_policy_version || null,
    admission_policy_id: lead.admission_policy_id || null,
    admission_policy_hash: lead.admission_policy_hash || null,
    governance_source_sha: lead.governance_source_sha || null,
    outbound_eligible: lead.adaptive_intake ? false : null,
    auto_send: lead.adaptive_intake ? false : null,
    sensitive_docs_ack: lead.sensitive_docs_ack || null,
    claim_stage: lead.claim_stage || null,
    valuation_purpose: lead.valuation_purpose || null,
    inspection_window: lead.inspection_window || null,
    property_class: lead.property_class || null,
    work_type: lead.work_type || null,
    work_stage: lead.work_stage || null,
    project_status: lead.project_status || null,
    budget_class: lead.budget_class || null,
    bim_status: lead.bim_status || null,
    establishment_class: lead.establishment_class || null,
    risk_class: lead.risk_class || null,
    sst_doc_class: lead.sst_doc_class || null,
    certame_stage: lead.certame_stage || null,
    contract_relation: lead.contract_relation || null,
    entity_class: lead.entity_class || null,
