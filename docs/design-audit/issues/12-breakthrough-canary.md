...
O primeiro webfont do site sobe o orçamento em `data/site/design-system.json` de `font_files_max: 0 / font_total_gzip_kb_max: 0` para `1 / 60`, com o arquivo medido em **58,7 KB gzip**, servido de `assets/archivo-var-latin-b19be0f7.woff2` e carregado **só na home**. Isso é exatamente o que a nota do próprio orçamento previa: *"O primeiro webfont deve elevar estes dois números neste arquivo, para que apareça como delta revisado em vez de ser absorvido em silêncio."*
...
antes (`583d2d88e`) e 20 depois (`7edeb0b0d`), nos cinco viewports do protocolo
