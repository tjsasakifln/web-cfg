...
| 134 | 64 | none | founder-led QCO cycle JSON (histórico) | honesty | none | 3 | none | green | closed/moved | RETIRE_WRONG_AUTHORITY | Warmbly/Governance own the operation | #64 foi fechada; este artefato não é trabalho executável do `web-cfg` |
