...
Generated: `2026-08-18T03:20:00Z`
...
- **eligibility**: `TRUE` · source `live_http+local_inspect` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `keep_observe_do_not_change_copy`
- **appearance**: `BLOCKED` · source `url_inspection+gsc_search_analytics` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `founder_gsc_manual_then_live_export`
- **referral**: `UNKNOWN` · source `analytics_not_imported` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `import_referral_when_available`
- **engagement**: `UNKNOWN` · source `analytics_not_imported` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `observe_engaged_sessions_separately`
- **cta_lead**: `UNKNOWN` · source `lead_store_not_joined` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `do_not_infer_lead_from_cta_presence`
- **pipeline**: `UNKNOWN` · source `warmbly_not_observed` · freshness `2026-08-18T03:20:00Z` · owner `Tiago Sasaki` · next `do_not_invent_pipeline`
...
Notification only (not indexation). Discovery `--send` remains refused.
Existing sender `node scripts/site/indexnow_submit.mjs` returned HTTP 200 for the four canonicals.
Receipt: `INDEXNOW_NOTIFICATION.txt`. Do not treat this as INDEX/APPEARANCE.

## Highest-value next action

Invite a read-only Search Console service account to `sc-domain:confenge.com.br` and run `python3 scripts/revops/search_demand_observatory.py pull-api --days 7 --smoke`. Then complete the four-URL “Solicitar indexação” checklist. Do not write more pages.
