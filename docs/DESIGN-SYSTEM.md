...
- **Uma família em todas as rotas: Archivo Var** (`assets/archivo-var-latin-b19be0f7.woff2`, SIL OFL 1.1, subconjunto latino pt-BR, eixos wght 100-900 e wdth 78-100 — a faixa de largura que o CSS publicado usa; 42 KB desde 2026-09-19). O `@font-face` vive em `css/identity.css` e chega a todas as rotas por `styles.css`. Até 2026-09-16 só a home carregava a fonte (`assets/home-10x.css`); as outras 260 rotas renderizavam em sans do sistema com H1 de até 80 px, e o visitante mudava de "site" ao clicar. Essa era a causa raiz de o conceito não virar percepção.
