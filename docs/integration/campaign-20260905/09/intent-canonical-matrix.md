...
| projeto complementar, compatibilização, BIM ou apoio de orçamento | `/servicos/` | `servicos-corporativos` | `/triagem-tecnica/#projetos` é ação, não canonical informacional | `index,follow` | Não até existir oferta/rota específica comprovada |
