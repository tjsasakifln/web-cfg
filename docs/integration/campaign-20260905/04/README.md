...
Em 2026-09-05, `https://confenge.com.br/api/build-info` informava o mesmo SHA da base. A home publicada ainda usava título e H1 exclusivos de licitações/contratos públicos. A rota `/servicos/` respondia com redirecionamento permanente para `/servicos-obras-publicas/`.
...
Gates e resultados ficam na PR. A verificação de primeira dobra mede 390×844 e 1366×768, exige um único CTA primário visível, alvo mínimo de 44 px, contraste de pelo menos 4,5:1, ausência de overflow e presença das mensagens essenciais.
