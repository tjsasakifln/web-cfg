# Gap matrix final (pós-implementação repositório)

| Ativo | Repo | Produção (antes deploy deste tip) | Prioridade residual |
| --- | --- | --- | --- |
| Lead seguro + persistência | Implementado + testes | Ainda ntfy público | Deploy + Blobs + env |
| E-mail transacional | Resend path | FormSubmit 403 | Resend+DNS |
