...
| tempo esgotado | idem, variante (`js/modules/form.js:542`) | "Não recebemos a confirmação a tempo. O seu pedido pode ter sido registrado [travessão no original] não reescreva os dados: tente enviar de novo, ou use o WhatsApp abaixo. O protocolo só aparece depois da gravação confirmada." (contém travessão) | "Não recebemos a confirmação a tempo. O seu pedido pode ter sido registrado; não reescreva os dados. Tente enviar de novo ou use o WhatsApp abaixo. O protocolo só aparece depois que o registro é confirmado." |
