...
const FORWARD = Object.freeze({
  CREATED: Object.freeze(["CREATED", "PAYMENT_PENDING", "PAYMENT_OVERDUE", "PAYMENT_CONFIRMED", "PAYMENT_RECEIVED", "PAYMENT_REFUNDED"]),
  PAYMENT_PENDING: Object.freeze(["PAYMENT_PENDING", "PAYMENT_OVERDUE", "PAYMENT_CONFIRMED", "PAYMENT_RECEIVED", "PAYMENT_REFUNDED"]),
  PAYMENT_OVERDUE: Object.freeze(["PAYMENT_OVERDUE", "PAYMENT_CONFIRMED", "PAYMENT_RECEIVED", "PAYMENT_REFUNDED"]),
  PAYMENT_CONFIRMED: Object.freeze(["PAYMENT_CONFIRMED", "PAYMENT_RECEIVED", "PAYMENT_REFUNDED"]),
