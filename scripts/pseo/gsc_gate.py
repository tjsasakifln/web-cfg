    ...
    base.update(
        {
            ...
            "state": state,
            "evidence_origin": raw.get("evidence_origin") or raw.get("origin"),
            "captured_at": raw.get("captured_at") or raw.get("capture_date"),
            "declared_canonical": raw.get("declared_canonical"),
            "google_canonical": raw.get("google_canonical"),
            "last_crawl_at": raw.get("last_crawl_at") or raw.get("last_crawl_time"),
            "coverage": raw.get("coverage") or raw.get("coverage_state"),
