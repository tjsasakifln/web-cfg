...
PURCHASE_ROUTE_MAP_SCHEMA = "confenge-purchase-route-map/v1"
PURCHASE_ROUTE_MAP_PATH = DATA_DIR / "purchase-route-map.v1.json"
PURCHASE_ROUTE_MAP_DOC_PATH = DOCS_DIR / "PURCHASE-ROUTE-MAP.md"
