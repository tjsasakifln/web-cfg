  ...
  return [...String(html).matchAll(/<form\b([^>]*)>([\s\S]*?)<\/form>/gi)]
    ...
    .map(({ attrs, body }) => {
      ...
      return {
        ...
        pre_form_value: markerText(body, "data-form-value"),
        pre_form_value_visible: Boolean(markerText(body, "data-form-value")),
        field_purpose: {
          visible_text: markerText(body, "data-field-purpose"),
          visible: Boolean(markerText(body, "data-field-purpose")),
          required: fields.required,
          optional: fields.optional,
        },
        boundary: markerText(body, "data-form-boundary"),
        boundary_visible: Boolean(markerText(body, "data-form-boundary")),
