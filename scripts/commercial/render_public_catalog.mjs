...
<article class="capability-group"><div class="capability-group__body"><h3>Projetos, revisão e compatibilização</h3><p>Cálculos, plantas, detalhes, especificações e memória de cálculo; relatório de revisão com pontos localizados; ou registro das interferências e soluções entre estruturas e instalações hidrossanitárias, elétricas, de incêndio, climatização e telecomunicações.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo</strong> mostra como o conteúdo da entrega se organiza. Não é um trabalho executado nem representa cliente, e por si só não comprova experiência: os fundamentos de confiança estão em <a href="/confianca/">credenciais e limites</a>.</p><p class="capability-group__schema-title">Como o conteúdo do projeto se organiza</p><ol class="capability-group__schema-list"><li><strong>Plantas e cortes</strong> onde cada elemento fica e como a obra se lê no papel.</li><li><strong>Detalhes</strong> as ligações e os pontos que a planta não consegue mostrar na mesma escala.</li><li><strong>Especificações</strong> o que cada material e serviço precisa atender para ser aceito.</li><li><strong>Memória de cálculo</strong> os critérios e as verificações que sustentam o que foi dimensionado.</li><li><strong>Registro de compatibilização</strong> as interferências encontradas entre disciplinas e a solução acordada para cada uma.</li></ol><p class="capability-group__schema-note">Cada peça responde a uma pergunta diferente na obra: a planta orienta a execução, o detalhe resolve a ligação, a especificação define o aceite e a memória sustenta a decisão técnica.</p></div><p><a href="/servicos/#servico-projeto">Entender o trabalho de projeto</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Quantitativos e orçamento</h3><p>Planilha de serviços e quantidades, memória dos critérios, composições abertas, referências e data-base para comparar propostas, preparar contratação ou revisar a estimativa de obra pública ou privada.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo</strong> mostra como o conteúdo da entrega se organiza. Não é um trabalho executado nem representa cliente, e por si só não comprova experiência: os fundamentos de confiança estão em <a href="/confianca/">credenciais e limites</a>.</p><p class="capability-group__schema-title">Como o orçamento se forma</p><ol class="capability-group__schema-list"><li><strong>Levantamento de quantidades</strong> o que será executado e quanto, item a item, com o critério de medição declarado.</li><li><strong>Composições de custo</strong> mão de obra, material e equipamento de cada serviço, abertos para conferência.</li><li><strong>Referências e data-base</strong> a fonte de preço adotada e a data a que ela se refere.</li><li><strong>Planilha orçamentária</strong> o total por item e por etapa, na estrutura em que a proposta será comparada.</li><li><strong>Memória dos critérios</strong> o que foi incluído, o que foi excluído e por quê.</li></ol><p class="capability-group__schema-note">É essa cadeia que permite comparar propostas pelo mesmo critério, em vez de comparar apenas o preço final.</p></div><p><a href="/quantitativos-orcamento-obras/">Ver quantitativos e orçamento de obras</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Inspeção, perícia, avaliação e segurança do trabalho</h3><p>Relatório, laudo, parecer, avaliação ou documentação técnica com evidências, método, conclusão e limites adequados à pergunta. O documento serve para decidir manutenção, registrar condição, sustentar prova, fundamentar valor ou orientar controles.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo</strong> mostra como o conteúdo da entrega se organiza. Não é um trabalho executado nem representa cliente, e por si só não comprova experiência: os fundamentos de confiança estão em <a href="/confianca/">credenciais e limites</a>.</p><p class="capability-group__schema-title">Como o laudo, o parecer ou a avaliação se estrutura</p><ol class="capability-group__schema-list"><li><strong>Objeto e pergunta</strong> o que foi examinado e o que precisa ser respondido.</li><li><strong>Evidências</strong> o que foi observado, medido ou obtido em documento, com data e origem.</li><li><strong>Método</strong> como as evidências foram analisadas e qual norma ou referência foi aplicada.</li><li><strong>Conclusão</strong> a resposta à pergunta, delimitada ao que as evidências sustentam.</li><li><strong>Limites</strong> o que o documento não conclui e o que exigiria investigação adicional.</li></ol><p class="capability-group__schema-note">A conclusão só vale dentro do método e dos limites declarados. É isso que permite usá-la para decidir manutenção, sustentar prova, fundamentar valor ou orientar controles.</p></div><p><a href="/servicos/#servico-diagnostico">Conhecer os demais serviços de engenharia</a></p></div></article>
</div>
