...
function vitrineCard(entry, contractItem) {
  ...
  return `${open}
<header class="vitrine-item__head"><span class="list-ruled__kicker offer-state">Oferta publicada</span><h2 id="${headingId}">${escapeHtml(entry.public_name_pt_br)}</h2><p class="vitrine-item__price"><span>Preço</span><strong>${escapeHtml(priceLabel(entry))}</strong></p></header>
