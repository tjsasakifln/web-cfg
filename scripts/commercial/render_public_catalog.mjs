...
<article class="capability-group"><div class="capability-group__body"><h3>Projetos, revisão e compatibilização</h3><p>Cálculos, plantas, detalhes, especificações e memória de cálculo; relatório de revisão com pontos localizados; ou registro das interferências e soluções entre estruturas e instalações hidrossanitárias, elétricas, de incêndio, climatização e telecomunicações.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo da entrega.</strong> A estrutura do que você recebe e para que serve cada peça. Modelo de organização do conteúdo, sem obra executada e sem dados de cliente.</p><p class="capability-group__schema-title">Como o conteúdo do projeto se organiza</p><ol class="capability-group__schema-list"><li><strong>Plantas e cortes</strong> onde cada elemento fica e como a obra se lê no papel.</li><li><strong>Detalhes</strong> as ligações e os pontos que a planta não consegue mostrar na mesma escala.</li><li><strong>Especificações</strong> o que cada material e serviço precisa atender para ser aceito.</li><li><strong>Memória de cálculo</strong> os critérios e as verificações que sustentam o que foi dimensionado.</li><li><strong>Registro de compatibilização</strong> as interferências encontradas entre disciplinas e a solução acordada para cada uma.</li></ol><p class="capability-group__schema-note">Cada peça responde a uma pergunta diferente na obra: a planta orienta a execução, o detalhe resolve a ligação, a especificação define o aceite e a memória sustenta a decisão técnica.</p></div><p><a href="/servicos/#servico-projeto">Entender o trabalho de projeto</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Quantitativos e orçamento</h3><p>Planilha de serviços e quantidades, memória dos critérios, composições abertas, referências e data-base para comparar propostas, preparar contratação ou revisar a estimativa de obra pública ou privada.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo da entrega.</strong> A estrutura do que você recebe e para que serve cada peça. Modelo de organização do conteúdo, sem obra executada e sem dados de cliente.</p><p class="capability-group__schema-title">Como o orçamento se forma</p><ol class="capability-group__schema-list"><li><strong>Levantamento de quantidades</strong> o que será executado e quanto, item a item, com o critério de medição declarado.</li><li><strong>Composições de custo</strong> mão de obra, material e equipamento de cada serviço, abertos para conferência.</li><li><strong>Referências e data-base</strong> a fonte de preço adotada e a data a que ela se refere.</li><li><strong>Planilha orçamentária</strong> o total por item e por etapa, na estrutura em que a proposta será comparada.</li><li><strong>Memória dos critérios</strong> o que foi incluído, o que foi excluído e por quê.</li></ol><p class="capability-group__schema-note">É essa cadeia que permite comparar propostas pelo mesmo critério, em vez de comparar apenas o preço final.</p></div><p><a href="/quantitativos-orcamento-obras/">Ver quantitativos e orçamento de obras</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Inspeção e diagnóstico de edificações</h3><p>Relatório de inspeção, laudo de estado ou documentação técnica do que existe, com localização das evidências e a condição encontrada. Serve para priorizar manutenção, orçar reparo, registrar a situação do imóvel ou decidir a intervenção.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo da entrega.</strong> A estrutura do que você recebe e para que serve cada peça. Modelo de organização do conteúdo, sem obra executada e sem dados de cliente.</p><p class="capability-group__schema-title">Como o relatório de inspeção se organiza</p><ol class="capability-group__schema-list"><li><strong>Objeto e acesso</strong> o que foi inspecionado, em que data e o que pôde ser visto no local.</li><li><strong>Manifestações registradas</strong> onde cada fissura, infiltração ou desgaste aparece, com localização.</li><li><strong>Origem provável</strong> a explicação técnica compatível com o que foi observado.</li><li><strong>Recomendação</strong> o que fazer, em que ordem, e o que precisa ser investigado antes.</li><li><strong>Limites do exame</strong> o que não foi acessível e o que dependeria de ensaio ou abertura.</li></ol><p class="capability-group__schema-note">A inspeção descreve a condição do que existe. Ela orienta manutenção e reparo, e não substitui a perícia quando a pergunta é de responsabilidade ou de prova.</p></div><p><a href="/servicos/#servico-diagnostico">Entender inspeção e diagnóstico</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Perícia, assistência técnica e avaliação</h3><p>Laudo pericial, parecer de assistente técnico ou laudo de avaliação com método declarado, evidências rastreáveis e conclusão delimitada. Serve para sustentar prova, apoiar a parte numa discussão técnica ou fundamentar o valor de um imóvel.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo da entrega.</strong> A estrutura do que você recebe e para que serve cada peça. Modelo de organização do conteúdo, sem obra executada e sem dados de cliente.</p><p class="capability-group__schema-title">Como o laudo, o parecer ou a avaliação se estrutura</p><ol class="capability-group__schema-list"><li><strong>Objeto e quesitos</strong> o que foi examinado e as perguntas que o documento precisa responder.</li><li><strong>Evidências</strong> o que foi observado, medido ou obtido em documento, com data e origem.</li><li><strong>Método</strong> como as evidências foram analisadas e qual norma ou referência foi aplicada.</li><li><strong>Conclusão</strong> a resposta aos quesitos, delimitada ao que as evidências sustentam.</li><li><strong>Limites</strong> o que o documento não conclui e o que exigiria investigação adicional.</li></ol><p class="capability-group__schema-note">Diferente da inspeção, aqui a pergunta é de prova ou de valor: o método declarado e a rastreabilidade das evidências são o que permite a terceiros conferir a conclusão. O papel técnico permanece separado do trabalho jurídico.</p></div><p><a href="/servicos/#servico-pericia">Entender perícia, assistência e avaliação</a></p></div></article>
<article class="capability-group"><div class="capability-group__body"><h3>Segurança do trabalho</h3><p>Programa de gerenciamento de risco ocupacional, laudo das condições de exposição, parecer sobre adequação de frente de obra ou relatório de assistência técnica, dentro da atribuição profissional confirmada para o objeto.</p><div class="capability-group__schema"><p class="capability-group__schema-label"><strong>Esquema ilustrativo da entrega.</strong> A estrutura do que você recebe e para que serve cada peça. Modelo de organização do conteúdo, sem obra executada e sem dados de cliente.</p><p class="capability-group__schema-title">Como o documento de segurança do trabalho se organiza</p><ol class="capability-group__schema-list"><li><strong>Atividades e frentes</strong> o que é executado, por quem e em que condição.</li><li><strong>Agentes e exposição</strong> os riscos identificados e como a exposição foi caracterizada.</li><li><strong>Controles existentes</strong> o que já está implantado e o que a documentação interna registra.</li><li><strong>Medidas e prioridade</strong> o que corrigir, em que ordem, e o que depende de terceiros.</li><li><strong>Registros</strong> o que precisa ser mantido e revisado, e em que periodicidade.</li></ol><p class="capability-group__schema-note">O documento serve para corrigir controles, manter registros e subsidiar a assistência técnica. Atribuições de engenharia não se confundem com atos médicos.</p></div><p><a href="/servicos/#servico-sst">Entender segurança do trabalho</a></p></div></article>
</div>
