...
<header><p class="eyebrow">Próxima camada pelo tipo de decisão</p><h3 id="offer-value-ladder-title">Unidade, Diagnóstico ou direção recorrente?</h3><p>A escolha começa pela situação e pelo escopo da decisão, não apenas pelo preço.</p></header>
<ol><li data-ladder-step="unit"><strong>Uma unidade basta</strong><span>Quando há uma pergunta delimitada e o escopo cabe no que a oferta declara.</span></li>
...
<div class="container">
<header class="deliverables-vitrine__intro"><p class="eyebrow">Ofertas com preço publicado</p><h2 id="catalog-title">Oito análises para licitações e mercado de obras públicas.</h2><p>Cada oferta diz a decisão que ela sustenta, o trabalho incluído, as informações necessárias, o conteúdo entregue, como você o usa, o preço e o prazo. Os demais serviços de engenharia seguem por proposta porque variam com disciplina, fase, documentos e responsabilidade.</p></header>
