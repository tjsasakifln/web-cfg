...
def test_each_published_offer_has_one_primary_representation_with_essential_terms() -> None:
    ...
    for card in primary:
        ...
        # Campanha POS-REDESIGN-FECHAMENTO-20260918 (G02-09): o kicker por
        # cartao "Oferta publicada" saiu; a publicacao e dita uma vez, no
        # cabecalho da secao ("Ofertas com preço publicado", cobrado em
        # test_hub_is_honest_about_every_published_example), e cada cartao
        # segue com o preco.
