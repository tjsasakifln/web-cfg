...
REPLACEMENTS = (
    ...
    ("Diagnóstico B2G de Expansão CFG-DIAG-EXP-v1", "Diagnóstico de Expansão no Mercado Público"),
    ("%20CFG-DIAG-EXP-v1", ""),
    ("<strong>CFG-DIRB2G-FLEX-v1</strong> - CONFENGE - Diretoria B2G Fracionada - Flex", "<strong>Plano Mensal</strong>"),
    ("<strong>CFG-DIRB2G-180-v1</strong> - CONFENGE - Diretoria B2G Fracionada - 180", "<strong>Compromisso Semestral</strong>"),
    ("<strong>CFG-DIRB2G-365-v1</strong> - CONFENGE - Diretoria B2G Fracionada - 365", "<strong>Compromisso Anual</strong>"),
