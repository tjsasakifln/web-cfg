...
export const SUITE_GRAPH = Object.freeze({
  ...
  "test:offer-fit": {
    producers: [
      "tests/commercial/test_offer_fit_matrix.mjs",
      "tests/commercial/test_offer_fit_copy.mjs",
      "scripts/commercial/offer_fit.mjs",
      "scripts/site/test_home_real_contract_case.py",
      "data/commercial/offer-fit-matrix.v1.json",
      "data/commercial/pricing-policy.v1.json",
      "js/modules/offer-fit.js",
      "index.html",
  ...
  "test:public-offer-truth": {
    producers: [
      "tests/commercial/test_public_offer_truth.mjs",
      "scripts/commercial/public_offer_truth.mjs",
      "data/commercial/public-offer-truth.v1.json",
      "data/commercial/deliverables-registry.v1.json",
      "data/offers/catalog.snapshot.json",
  ...
  "test:bofu-ownership": {
    // #545's buyer-decision projection is an internal authority over existing
    // canonical routes. Its GSC inputs remain fail-closed: UNKNOWN is not a
    // demand, ranking, or ownership result.
    producers: [
      "tests/bofu_dominance/core/test_buyer_decision_map.py",
      ...
      "data/organic/public-family-registry.json",
      "seo/gsc-2026-08-31/manual-page-snapshot.v1.json",
      "seo/gsc-2026-08-31/source-manifest.v1.json",
      "docs/seo/bofu-dominance/core/",
    ],
    artifacts: [
      "docs/seo/bofu-dominance/core/BUYER-DECISION-MAP.md",
      "docs/seo/bofu-dominance/core/NEXT-ACTIONS.md",
      "docs/seo/bofu-dominance/core/REPORT.md",
    ],
    surfaces: [
      "/diagnostico-pre-licitacao/",
      "/auditoria-orcamento-licitacao/",
  ...
  "test:commercial-release-ledger": {
    // #554 binds the final public treatment to one exact SHA and records
    // measurement only. The ledger must keep UNKNOWN values and cannot make
    // a causal claim or mutate the protected routes it observes.
    producers: [
      "scripts/organic/tests/test_integrated_commercial_release_ledger.py",
      "scripts/organic/release_measurement_ledger.py",
  ...
  "test:deliverables-live-audit": {
    producers: [
      "scripts/site/audit_deliverables_live.mjs",
      "scripts/site/deliverables_live_audit_contract.mjs",
      "scripts/site/test_deliverables_live_audit.mjs",
      "scripts/site/fixtures/deliverables-live/",
      "scripts/site/capture_states.mjs",
      "scripts/site/resolve_chrome.mjs",
      "docs/evidence/issue-530-live-2026-08-31/",
    ],
    artifacts: ["docs/evidence/issue-530-live-2026-08-31/"],
    surfaces: ["/entregas/", "/casos/modelo-*/"],
  },
  "test:report-model": {
    producers: [
  ...
  "test:site-excellence": {
    producers: [
      ...
      "scripts/site/fixtures/site-excellence/",
      "scripts/site/site_excellence.py",
      "scripts/site/test_site_excellence.py",
      "scripts/site/test_deliverables_hub_ui.mjs",
      "scripts/site/audit_axe.mjs",
      "scripts/site/public_copy_scope.py",
      "scripts/site/commercial_surface_truth.py",
      "scripts/site/inbound_gates.py",
      "scripts/site/seo_molds.py",
      "scripts/site/audit_performance.py",
      "scripts/organic/post_cutover_audit.py",
      "scripts/organic/sitemap_graph.py",
      "data/commercial/real-proof-registry.v1.json",
    ...
    surfaces: ["/", "/entregas/", "/.well-known/build-info.json"],
  },
  "test:cta-whatsapp": {
    producers: [
  ...
  "test:live-intelligence": {
    producers: [
      "scripts/site/test_live_intelligence_analyze.mjs",
      "scripts/site/test_live_intelligence_events.mjs",
      "scripts/site/test_identity_resolution.mjs",
      "tests/netlify/web-intent.test.cjs",
      "tests/netlify/web-intent-delivery.test.cjs",
      "tests/netlify/web-intent-http.test.cjs",
      "netlify/functions/live-intelligence-analyze.cjs",
      "netlify/functions/lead.cjs",
      "netlify/functions/lib/live-intelligence-result-store.cjs",
      "netlify/functions/lib/identity-resolver.cjs",
      "netlify/functions/lib/web-intent-builder.cjs",
      "netlify/functions/lib/inbound-handoff.cjs",
      "assets/js/live-intelligence.js",
      "data/live_intelligence/",
    ],
    artifacts: [],
    surfaces: ["/analise-cnpj/", "/analise-cnpj/r/", "/oportunidades/"],
  },
  "test:wave1-fields": {
  ...
  "test:capture-states": {
    producers: [
      ...
      "scripts/site/resolve_chrome.mjs",
      "docs/design-audit/evidence/capture-index.json",
      "docs/design-audit/evidence/breakthrough-capture-index.json",
  ...
  "test:design-direction": {
    ...
    artifacts: ["docs/design-audit/evidence/"],
    surfaces: [],
  },
  "test:indexnow": {
    producers: [
  ...
  "test:conversion": {
    producers: ["tests/conversion/", "scripts/conversion/", "data/conversion/", "docs/contracts/intent-action/", "tests/offers/", "scripts/offers/", "data/offers/", "scripts/offers/governance-pin.cjs", "data/offers/governance-authority-pin.json", "scripts/commercial/offer_fit.mjs", "data/commercial/offer-fit-matrix.v1.json"],
    artifacts: [],
