...
<p class="section-lead rv-note">Exemplo demonstrativo do <a href="${escapeHtml(url)}">recorte de banheiro</a> e do <a href="${escapeHtml(csvHref)}">arquivo de revisão</a>. Item de checklist não respondido e norma não examinada não viram erro do projeto.</p>
